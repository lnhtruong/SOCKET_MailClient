...
# Khởi tạo và nhập thông tin người dùng
    print ("Welcome to my mail server!")
    print ("Please enter your information below:")
    print ("When enter Username, you must add < and > around your mail name!")
    user_info = {'Username': input("Enter username <gmail>: "),
...
## Lọc và đưa tải vào các folder tương ứng
def load_filters():
    program_address = os.getcwd()
